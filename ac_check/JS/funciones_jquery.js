  ...
  function despintar_elemento(eti2, elemento){
    switch (true) {
      case (eti2 === 'span' || eti2 === 'b'):
        ...
        abuelo.replaceChild(padre[0], elemento.parentNode);
        /*
